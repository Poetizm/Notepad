...
from Notepad_GUI import Ui_MainWindow
...
class NotePadWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.actionUnderlined.triggered.connect(self.text_underlined)
    ...
    def about(self):
        QMessageBox.about(self, 'About App', 'This is simple notepad with PyQt6')
